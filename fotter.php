...
<footer class="bg-dark text-center text-white " id="footer">
    ...
    <div class="container p-4">
        ...
        <section class="mb-1">
            <!-- Facebook -->
            <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com" src="../images/Logofacebook.png" role="button"><i class="fab fa-facebook-f"></i></a>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2022 Copyright:
        <a class="text-white" href="https://mdbootstrap.com/">SuperPokemon.com</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
